...
class windowsLOgin extends StatefulWidget {
  @override
  State<windowsLOgin> createState() => _windowsLOginState();
}

class _windowsLOginState extends State<windowsLOgin> {
      ...
      if (jdata != null) {
        ...
        if (password == jdata["password"]) {
          ...
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => windowSelector()));
          // Fluttertoast.showToast(msg: "Sucessfully Logined");
          //   print(value);
          setState(() {
            isLoading = false;
